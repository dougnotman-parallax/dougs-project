import svgPaths from "./svg-1vrsqz78zs";

export default function Atlas() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[10px] items-center overflow-clip px-[12px] relative rounded-[6px] size-full" data-name="Atlas">
