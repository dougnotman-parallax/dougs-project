import svgPaths from "./svg-pq4awcjw3z";
        ...
        <div className="relative shrink-0 size-[16px]" data-name="ThumbUp">
          <div className="absolute inset-[12.34%_5.47%_11.91%_5.47%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.25 12.1202">
              <path clipRule="evenodd" d={svgPaths.p263fde80} fill="var(--fill-0, #191B1D)" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-center justify-center relative rounded-[6px] shrink-0 size-[28px]" data-name="Button">
        <div className="relative shrink-0 size-[16px]" data-name="ThumbDown">
          <div className="absolute inset-[12.34%_5.47%_9.84%_5.47%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.25 12.4504">
              <path clipRule="evenodd" d={svgPaths.p1b513780} fill="var(--fill-0, #191B1D)" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
